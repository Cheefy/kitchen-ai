...
- Persistent volumes (Ollama model cache in the Compose stack; Postgres's own data dir in its separate CA container) follow Unraid's `/mnt/user/appdata/<container>/` convention.
